...
def generate_radar_blueprint(blueprint_library):
    ...
    radar_blueprint.set_attribute("horizontal_fov",str(40))#write code here
    radar_blueprint.set_attribute("vertical_fov",str(30))#write code here
    radar_blueprint.set_attribute("points_per_second",str(15000))#write code here
    radar_blueprint.set_attribute("range",str(20))#write code here
...
def _Radar_callback(point_cloud_data):
    distance_name_data = {}
    for detection in radar_data:
        distance_name_data["distance"]=detection.depth

        if distance_name_data["distance"] > 3 and distance_name_data["distance"] < 7:
            print("slowing car speed")
